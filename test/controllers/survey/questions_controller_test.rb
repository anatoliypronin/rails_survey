...
class Survey::QuestionsControllerTest < ActionDispatch::IntegrationTest
  setup do
    @question = create :question
  end

  test "should get index questions" do
    get survey_questions_path(@question.survey_id)
    assert_response :success
  end

  test "should get new question page" do
    get new_survey_question_path(@question.survey_id)
    assert_response :success
  end
  ...
  test "should post create question" do
    ...
    post survey_questions_path(@question.survey_id), params: { question: question_attrs }
  ...
  test "should delete destroy question" do
    delete survey_question_path(@question.survey_id, @question)
    assert_response :redirect
